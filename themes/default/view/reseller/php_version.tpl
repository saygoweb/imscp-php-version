...
<script>
    (function ($) {
        ...
        // control is a convenience that fills them in, so a reseller with many
        // domains can set them all in one go and still see exactly what is
        // about to be submitted before pressing Apply.
